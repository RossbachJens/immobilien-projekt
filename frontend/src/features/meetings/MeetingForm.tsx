...
export function MeetingForm({ propertyId, onSubmit, onCancel, isSubmitting, error }: MeetingFormProps) {
  ...
  function handleSubmit(event: FormEvent) {
    ...
    onSubmit({
      ...
      meeting_time: isCircular ? null : meetingTime || null,
      location: isCircular ? null : location || null,
  ...
  return (
    <form onSubmit={handleSubmit} className="meeting-form">
      ...
      <label>
        {isCircular ? "Frist zur Stimmabgabe *" : "Datum *"}
        ...
        <>
          ...
          <label>
            ...
            <input
              ...
              placeholder="z.B. Restaurant Marmaris, Hanauer Straße 1"
            />
          </label>
        </>
      )}
